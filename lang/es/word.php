...
return [
    ...
    'general' => [
        ...
        'title_denomination'=> 'Monto de apertura',
    ...
    'method' => [
        ...
        'disable_confirmation' => '¿Está seguro de deshabilitar el método de transacción',
        'enable_confirmation' => '¿Está seguro de habilitar el método de transacción',
        'select_bank' => 'Seleccionar un banco',
        'delete_success' => 'Método de transacción eliminado correctamente.',
        'not_allow' => 'El método de transacción tiene registros asociados, por lo que no es posible eliminarlo.',
        'not_allow_delete' => 'El método de transacción "EFECTIVO" tiene registros asociados, por lo que no es posible eliminarlo.',
        'not_allow_update' => 'El método de transacción "EFECTIVO" tiene registros asociados, por lo que no es posible editarlo.',
        'meta' => [
            'create' => [
    ...
    'income' => [
        ...
        'sheet' => [
            "service" => "Servicio",
            "quantity" => "Cantidad",
            "method" => "Forma de transacción",
            "observation" => "Observación",
            "user" => "Responsable",
            "cash" => "Caja",
            "cash_amount" => "Monto caja",
            "bank" => "Banco",
            "bank_amount" => "Monto banco",
            "total_price" => "Precio Total",
            "total_register" => "Monto Registrado",
            "created_at" => "Fecha de registro",
