...
return [
  ...
  'service' => [
    'title' => 'Servicios precio variable',
    'titleprice' => 'Servicios precio fijo',
  ...
  'email' => [
    'sub_send_code_two_factor' => 'Código de seguridad de :app_name',
    'title' => 'BIENVENID@ A :app_name',
    'text_1' => ':name',
    'text_2' => ', utiliza el siguiente código para la verificación. Este correo te ayudara a iniciar sesión en el panel administrativo de :app_name',
    'text_3' => 'Este código de seguridad es de un solo uso, por lo que si requieres iniciar sesión tendrás que solicitar uno nuevo',
    'text_4' => 'Nota: Si usted no está realizando la inscripción en el :app_name, por favor ignore este correo y perdone las molestias.',
  ],
  'permissions' => [
    'dashboard_module' => 'Módulo de Dashboard',
    'all' => 'Puede acceder a todo el sistema',
    'dashboard' => 'Puede acceder al dashboard del sistema',
    'users_module' => 'Módulo de Usuarios',
    'users_list' => 'Puede ver la lista de usuarios',
    'user_view' => 'Puede ver el perfil de un usuario',
    'user_edit' => 'Puede editar la información de un usuario',
    'user_permissions' => 'Puede administrar los permisos de un usuario',
    'user_delete' => 'Puede eliminar un usuario',
  ],
  'sidebar' => [
    'dashboard' => 'Dashboard',
    'users_list' => 'Usuarios',
