"use strict"
const open_invoice_modal = (uuid, name) => {
    const modal = document.getElementById(`invoice-modal-${uuid}`);
    const title = document.getElementById(`invoice-name-${uuid}`);
    const modal_scale = document.getElementById(`scale-invoice-${uuid}`);
...
const close_invoice_modal = (uuid) => {
    const modal = document.getElementById(`invoice-modal-${uuid}`);
    const modal_scale = document.getElementById(`scale-invoice-${uuid}`);
