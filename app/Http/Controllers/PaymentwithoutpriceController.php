...
class PaymentwithoutpriceController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    'servicewithprice_uuid' => 'required|string|max:30|exists:servicewithprices,servicewithprice_uuid',
    'transactionmethod_uuid' => 'required|string|max:30|exists:transactionmethods,transactionmethod_uuid',
  ...
  public function show($paymentwithoutprice_uuid, Request $request)
  {
    ...
    return view('paymentwithoutprice.show', compact('paymentwithoutprice', 'denomination'));
  }
