<x-app-layout>
    <x-slot name="title">
        {{ __('word.payment.meta.create.title') }}
    </x-slot>
    <x-slot name="metaDescription">
        {{ __('word.payment.meta.create.description')}}
    </x-slot>
    <x-slot name="metaKeywords">
        {{ __('word.payment.meta.create.keywords')}}
    </x-slot>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('word.payment.resource.create') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-xl rounded-lg w-full mx-auto p-8">
                <form method="POST" action="{{ route('paymentwithprices.store') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="w-full">
                            <x-form-paymentwithprice-create :paymentwithprice="$paymentwithprice"
