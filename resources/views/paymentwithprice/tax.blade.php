...
<section>
    ...
    <p style="font-size: 10px; text-align: center; line-height: 0.3;"><b>COMPROBANTE N°.: </b>1999</p>
...
<section>
    ...
    <p style="font-size: 11px; line-height: 0.1; display: inline-block; float: left;">{{ $paymentwithprice->name }}</p>
    <p style="font-size: 11px; line-height: 0.1; display: inline-block; float: right;">{{ $paymentwithprice->total }}</p>
