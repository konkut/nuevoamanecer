...
<section>
    ...
    <p style="font-size: 10px; text-align: center; line-height: 0.3;"><b>FECHA DE EMISIÓN: </b>{{$paymentwithprice->created_at}}</p>
</section>
<p style="font-size: 8px; text-align: center; line-height: 0.2;">-----------------------------------------------------------------------------------------------------------------------</p>
<section>
    <p style="font-size: 11px; text-align: center; line-height: 0.2; margin-top: 17px;"><b>DETALLE</b></p>

    <p style="font-size: 11px; line-height: 0.1; display: inline-block; float: left;">{{ implode(', ', $paymentwithprice->services->toArray()) }}</p>
    <p style="font-size: 11px; line-height: 0.1; display: inline-block; float: right;">{{ $paymentwithprice->pagar }}</p>
    <div style="line-height: 0.1; margin: 0;clear: both;"></div>

    <p style="font-size: 11px; line-height: 0.1; display: inline-block; float: right;"><b>TOTAL:</b>&nbsp;&nbsp;&nbsp;{{ $paymentwithprice->pagar }}</p>
    <div style="line-height: 0.1; margin: 0; clear: both;"></div>

    <p style="font-size: 11px; line-height: 0.1; display: inline-block; float: right;"><b>{{ strtoupper(implode(', ', $paymentwithprice->methods->toArray())) }}:&nbsp;&nbsp;&nbsp;</b>{{ $paymentwithprice->cobrado }}</p>
    <div style="line-height: 0.1; margin: 0; clear: both;"></div>

    <p style="font-size: 11px; line-height: 0.1; display: inline-block; float: right;"><b>CAMBIO:&nbsp;&nbsp;&nbsp;</b>{{ $paymentwithprice->cambio }}</p>
    <div style="line-height: 0.1; margin: 0; clear: both;"></div>

    <p style="font-size: 11px; line-height: 0.1; display: inline-block; float: right;"><b>MONTO A PAGAR:&nbsp;&nbsp;&nbsp;</b>{{ $paymentwithprice->pagar }}</p>
    <div style="line-height: 0.1; margin: 0; clear: both;"></div>
</section>
