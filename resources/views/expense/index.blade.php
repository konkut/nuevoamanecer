                ...
                <div class="container mx-auto p-4">
                    <div class="flex justify-end gap-4 items-end mb-4 flex-wrap flex-col sm:flex-row">
                        ...
                        <form method="GET" action="{{ route('expenses.export') }}"
                            ...
                            <label for="filter" class="text-sm text-gray-600">{{__('word.general.filter_excel')}}</label>
                            ...
                            <div id="custom-range" style="display: none;"
                                ...
                                <div class="space-x-4">
                                    <label for="start_date" class="text-sm text-gray-600">{{__('word.general.filter_range_start')}}</label>
                                    <input type="date" name="start_date" id="start_date"
                                           class="border border-gray-300 p-2 rounded text-gray-600">
                                </div>
                                <div class="space-x-4">
                                    <label for="end_date" class="text-sm text-gray-600">{{__('word.general.filter_range_end')}}</label>
                        ...
                        <form method="GET" action="{{ route('expenses.index') }}" onchange="this.submit()"
                            ...
                            <label for="perPage" class="text-sm text-gray-600">{{__('word.general.filter_show')}}</label>
