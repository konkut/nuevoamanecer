<x-app-layout>
    ...
    <x-slot name="js_files">
        ...
        <script type="text/javascript"
                src="{{ asset('/js/cashregister/fetch_detail_cashregister.js?v='.time()) }}"></script>
    </x-slot>
    <x-slot name="header">
                        ...
                        <table class="min-w-full border-collapse border-[#2563eb] text-center text-sm">
                            ...
                            @foreach($cashregisters as $item)
                                                ...
                                                <div class="text-center py-6 md:pb-0"
                                                    ...
                                                    <div class="grid grid-cols-3 gap-4 px-8">
                                                        <div class="col-span-1">
                                                            <div
                                                                class="text-start text-gray-700 font-extrabold text-sm py-2">
                                                                CORTE
                                                            </div>
                                                        ...
                                                        <div class="col-span-1">
                                                            <div
                                                                class="text-center text-gray-700 font-extrabold text-sm py-2">
                                                                CANTIDAD
                                                            </div>
                                                            <div class="text-center"
                                                                 id="quantity-bill-200-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-center"
                                                                 id="quantity-bill-100-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-center"
                                                                 id="quantity-bill-50-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-center"
                                                                 id="quantity-bill-20-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-center"
                                                                 id="quantity-bill-10-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-center"
                                                                 id="quantity-coin-5-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-center"
                                                                 id="quantity-coin-2-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-center"
                                                                 id="quantity-coin-1-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-center"
                                                                 id="quantity-coin-0-5-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-center"
                                                                 id="quantity-coin-0-2-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-center"
                                                                 id="quantity-coin-0-1-{{$item->cashregister_uuid}}"></div>
                                                        </div>
                                                        <div class="col-span-1">
                                                            <div
                                                                class="text-end text-gray-700 font-extrabold text-sm py-2">
                                                                TOTAL
                                                            </div>
                                                            <div class="text-end"
                                                                 id="operation-bill-200-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-end"
                                                                 id="operation-bill-100-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-end"
                                                                 id="operation-bill-50-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-end"
                                                                 id="operation-bill-20-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-end"
                                                                 id="operation-bill-10-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-end"
                                                                 id="operation-coin-5-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-end"
                                                                 id="operation-coin-2-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-end"
                                                                 id="operation-coin-1-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-end"
                                                                 id="operation-coin-0-5-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-end"
                                                                 id="operation-coin-0-2-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-end"
                                                                 id="operation-coin-0-1-{{$item->cashregister_uuid}}"></div>
                                                            <div class="text-end"
                                                                 id="total-{{$item->cashregister_uuid}}"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <div class="modal-header p-4 border-b flex justify-between items-center">
                                                ...
                                                <button type="button"
                                                        ...
                                                        onclick="close_disable_modal('{{$item->cashregister_uuid}}')">
                                                    &times;
                                                </button>
                                            </div>
                                            ...
                                            <div class="modal-footer p-4 border-t flex justify-end space-x-2">
                                                ...
                                                <form
                                                    action="{{route('cashregisters.disable',$item->cashregister_uuid)}}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <button type="submit"
                                    ...
                                    <div class="flex items-center justify-center min-h-screen"
                                        ...
                                        <div
                                            ...
                                            <div class="modal-header p-4 border-b flex justify-between items-center">
                                                ...
                                                <button type="button"
                                                        class="close-modal text-gray-500 hover:text-gray-700 text-2xl"
                                                        onclick="close_enable_modal('{{$item->cashregister_uuid}}')">
                                                    &times;
                                                </button>
                                            </div>
                                            <div class="modal-body p-6">
                                            ...
                                            <div class="modal-footer p-4 border-t flex justify-end space-x-2">
                                                ...
                                                <form
                                                    action="{{route('cashregisters.enable',$item->cashregister_uuid)}}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <button type="submit"
                                ...
                                <div id="modal-{{$item->cashregister_uuid}}"
                                     class="hidden fixed inset-0 bg-black/60 bg-opacity-50 z-50 overflow-y-auto">
                                    <div class="flex items-center justify-center min-h-screen"
                                         id="scale-delete-{{$item->cashregister_uuid}}">
                                        <div
                                            class="bg-white rounded-lg shadow-lg w-5/6 sm:w-3/6 lg:w-2/6 transform transition-all scale-100 opacity-100 duration-300">
                                            <div class="modal-header p-4 border-b flex justify-between items-center">
                                                ...
                                                <button type="button"
                                                        class="close-modal text-gray-500 hover:text-gray-700 text-2xl"
                                                        onclick="closeModal('{{$item->cashregister_uuid}}')">&times;
                                                </button>
                                            </div>
                                            <div class="modal-body p-6">
