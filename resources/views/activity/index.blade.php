<x-app-layout>
    <x-slot name="title">
        {{ __('word.activity.meta.index.title') }}
    </x-slot>
    <x-slot name="metaDescription">
        {{ __('word.activity.meta.index.description')}}
    </x-slot>
    <x-slot name="metaKeywords">
        {{ __('word.activity.meta.index.keywords')}}
    </x-slot>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('word.activity.resource.index') }}
        </h2>
    </x-slot>
    @if (session('success'))
            ...
            <div class="overflow-hidden shadow-xl sm:rounded-lg">
                <div class="container mx-auto p-4">
                        ...
                        <table class="min-w-full border-collapse border-[#2563eb] text-center text-sm">
                            ...
                            <tr class="bg-[#d1d5db]" title="{{__('word.general.title_icon_filter')}}">
                                ...
                                <th class="border-t border-b border-[#d1d5db] px-2 py-1 cursor-pointer"
                                    onclick="enableSearch(this, '{{ __('word.activity.filter.name') }}')">{{ __('word.activity.attribute.name') }}</th>
                                <th class="border-t border-b border-[#d1d5db] px-2 py-1 cursor-pointer"
                                    onclick="enableSearch(this, '{{ __('word.activity.filter.start') }}')">{{ __('word.activity.attribute.start') }}</th>
                                <th class="border-t border-b border-[#d1d5db] px-2 py-1 cursor-pointer"
                                    onclick="enableSearch(this, '{{ __('word.activity.filter.end') }}')">{{ __('word.activity.attribute.end') }}</th>
                                <th class="border-t border-b border-[#d1d5db] px-2 py-1 cursor-pointer"
                                    onclick="enableSearch(this, '{{ __('word.activity.filter.user_id') }}')">{{ __('word.activity.attribute.user_id') }}</th>
                                <th class="border-t border-b border-[#d1d5db] px-2 py-1 cursor-pointer"
                                    onclick="enableSearch(this, '{{ __('word.activity.filter.created_at') }}')">{{ __('word.activity.attribute.created_at') }}</th>
                                <th class="border-t border-b border-[#d1d5db] px-2 py-1 cursor-pointer"
                                    onclick="enableSearch(this, '{{ __('word.activity.filter.updated_at') }}')">{{ __('word.activity.attribute.updated_at') }}</th>
                                <th class="border-t border-b border-[#d1d5db] px-2 py-1 cursor-pointer"
                                    onclick="enableSearch(this, '{{ __('word.activity.filter.status') }}')">{{ __('word.activity.attribute.status') }}</th>
                            ...
                            @foreach($activities as $item)
                                        ...
                                        <div class="flex justify-center space-x-1">
                                            @can('activities.index')
                                                <a href="javascript:void(0);"
                                                   ...
                                                   onclick="openDetailsModal('{{$item->activity_uuid}}')">
                                    ...
                                    <div class="flex items-center justify-center min-h-screen"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <h1 class="text-lg font-semibold mx-auto">{{__('word.activity.resource.show')}}</h1>
                                                <button type="button"
                                                        class="text-gray-600 hover:text-gray-900 text-2xl absolute top-4 right-4"
                                                        onclick="closeDetailsModal('{{$item->activity_uuid}}')">
                                                    &times;
                                                </button>
                                            </div>
                                            <div class="modal-body py-6 text-gray-700 overflow-hidden text-center">
                                                <div>
                                                    <p class="text-sm font-semibold">{{ __('word.activity.attribute.name') }}</p>
                                                    <p>{{ $item->name }}</p>
                                                </div>
                                                <div class="mt-2">
                                                    <p class="text-sm font-semibold">{{ __('word.activity.attribute.start') }}</p>
                                                    <p>{{ $item->start_date }}</p>
                                                </div>
                                                <div class="mt-2">
                                                    <p class="text-sm font-semibold">{{ __('word.activity.attribute.end') }}</p>
                                                    <p>{{ $item->end_date }}</p>
                                                </div>
                                                @if($item->description)
                                                    <div class="mt-2">
                                                        <p class="text-sm font-semibold">{{ __('word.activity.attribute.description') }}</p>
                                                        <p>{{ $item->description }}</p>
                                                    </div>
                                                @endif
                                                <div class="mt-2">
                                                    <p class="text-sm font-semibold ">{{ __('word.activity.attribute.status') }}</p>
                                                    <p>{{ $item->status ? '🟢' : '🔴' }}</p>
                                                </div>
                                                <div class="mt-2">
                                                    <p class="text-sm font-semibold">{{ __('word.activity.attribute.user_id') }}</p>
                                                    <p>{{ $item->user->name }}</p>
                                                </div>
                                                <div class="mt-2">
                                                    <p class="text-sm font-semibold">{{ __('word.activity.attribute.created_at') }}</p>
                                                    <p>{{ $item->created_at->format('H:i d/m/Y') }}</p>
                                                </div>
                                                <div class="mt-2">
                                                    <p class="text-sm font-semibold">{{ __('word.activity.attribute.updated_at') }}</p>
                                ...
                                <div id="disable-modal-{{$item->activity_uuid}}"
                                     class="hidden fixed inset-0 bg-black/60 bg-opacity-50 z-50 overflow-y-auto">
                                    <div class="flex items-center justify-center min-h-screen"
                                         id="scale-disable-{{$item->activity_uuid}}">
                                        <div
                                            ...
                                            <div class="modal-header p-4 border-b flex justify-between items-center">
                                                ...
                                                <button type="button"
                                                        ...
                                                        onclick="close_disable_modal('{{$item->activity_uuid}}')">
                                                    &times;
                                                </button>
                                            </div>
                                            <div class="modal-body p-6">
                                                <p class="text-gray-600">{{__('word.activity.disable_confirmation')}}
                                                    <strong id="disable-name-{{$item->activity_uuid}}"></strong>?
                                                </p>
                                            </div>
                                            <div class="modal-footer p-4 border-t flex justify-end space-x-2">
                                                <button type="button"
                                                        class="bg-gray-300 text-gray-800 px-4 py-2 rounded transition duration-300 hover:bg-gray-400"
                                                        onclick="close_disable_modal('{{$item->activity_uuid}}')">{{ __('Close') }}</button>
                                                <form
                                                    action="{{route('activities.disable',$item->activity_uuid)}}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <button type="submit"
                                ...
                                <div id="enable-modal-{{$item->activity_uuid}}"
                                     class="hidden fixed inset-0 bg-black/60 bg-opacity-50 z-50 overflow-y-auto">
                                    <div class="flex items-center justify-center min-h-screen"
                                         id="scale-enable-{{$item->activity_uuid}}">
                                        <div
                                            class="bg-white rounded-lg shadow-lg w-5/6 sm:w-3/6 lg:w-2/6 transform transition-all scale-100 opacity-100 duration-300">
                                            <div class="modal-header p-4 border-b flex justify-between items-center">
                                                ...
                                                <button type="button"
                                                        class="close-modal text-gray-500 hover:text-gray-700 text-2xl"
                                                        onclick="close_enable_modal('{{$item->activity_uuid}}')">
                                                    &times;
                                                </button>
                                            </div>
                                            <div class="modal-body p-6">
                                                <p class="text-gray-600">{{__('word.activity.enable_confirmation')}}
                                                    <strong id="enable-name-{{$item->activity_uuid}}"></strong>?
                                                </p>
                                            </div>
                                            <div class="modal-footer p-4 border-t flex justify-end space-x-2">
                                                <button type="button"
                                                        class="bg-gray-300 text-gray-800 px-4 py-2 rounded transition duration-300 hover:bg-gray-400"
                                                        onclick="close_enable_modal('{{$item->activity_uuid}}')">{{ __('Close') }}</button>
                                                <form
                                                    action="{{route('activities.enable',$item->activity_uuid)}}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <button type="submit"
                                ...
                                <div id="modal-{{$item->activity_uuid}}"
                                     class="hidden fixed inset-0 bg-black/60 bg-opacity-50 z-50 overflow-y-auto">
                                    <div class="flex items-center justify-center min-h-screen"
                                        ...
                                        <div class="bg-white rounded-lg shadow-lg w-5/6 sm:w-3/6 lg:w-2/6 transform transition-all scale-100 opacity-100 duration-300">
                                            <div class="modal-header p-4 border-b flex justify-between items-center">
                                                ...
                                                <button type="button"
                                                        class="close-modal text-gray-500 hover:text-gray-700 text-2xl"
                                                        onclick="closeModal('{{$item->activity_uuid}}')">&times;
                                                </button>
                                            </div>
                                            <div class="modal-body p-6">
                                            ...
                                            <div class="modal-footer p-4 border-t flex justify-end space-x-2">
                                                <button type="button"
                                                        class="bg-gray-300 text-gray-800 px-4 py-2 rounded transition duration-300 hover:bg-gray-400"
                                                        onclick="closeModal('{{$item->activity_uuid}}')">{{ __('Close') }}</button>
                                                <form
                                                    action="{{route('activities.destroy',$item->activity_uuid)}}"
                                                    method="POST"
                                                    onsubmit="fetch_delete(this, '{{url('/')}}', '{{ $item->activity_uuid }}', event)">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                    ...
                    <div class="pagination-wrapper mt-4">
                        {!! $activities->appends(['perPage' => $perPage])->links() !!}
                    </div>
                </div>
            </div>
        </div>
