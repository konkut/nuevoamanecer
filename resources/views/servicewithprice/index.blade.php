                ...
                <div class="container mx-auto p-4">
                    <div class="flex justify-end space-x-2 items-center mb-4">
                        @can('serviceswithprices.create')
                            <a href="{{ route('serviceswithprices.create') }}"
                               class="bg-blue-400 text-white px-4 py-2 rounded text-sm"
                               title="Agregar">
                                <i class="bi bi-plus"></i>
                            </a>
                        @endcan
                        <form method="GET" action="{{ route('serviceswithprices.index') }}" onchange="this.submit()"
                              class="inline-block">
                    ...
                    <div class="overflow-x-auto text-black">
                        <table class="min-w-full border-collapse border-[#2563eb] text-center text-sm">
                            ...
                            <tr class="bg-[#d1d5db]" title="Buscar">
                                ...
                                <th class="border-t border-b border-[#d1d5db] px-2 py-1 cursor-pointer"
                                    onclick="enableSearch(this, 'monto')">{{ __('word.service.attribute.amount') }}</th>
                                <th class="border-t border-b border-[#d1d5db] px-2 py-1 cursor-pointer"
                            ...
                            @foreach($servicewithprices as $item)
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <button type="button"
                                                        ...
                                                        onclick="closeDetailsModal('{{$item->servicewithprice_uuid}}')">
                                                    &times;
                                                </button>
                                ...
                                <!-- Modal -->
                                <div id="modal-{{$item->servicewithprice_uuid}}"
                                        ...
                                        <div
                                            ...
                                            <div class="modal-header p-4 border-b flex justify-between items-center">
                                                ...
                                                <button type="button"
                                                        ...
                                                        onclick="closeModal('{{$item->servicewithprice_uuid}}')">&times;
                                                </button>
                                            </div>
                                            ...
                                            <div class="modal-footer p-4 border-t flex justify-end space-x-2">
                                                <button type="button"
                                                        ...
                                                        onclick="closeModal('{{$item->servicewithprice_uuid}}')">{{ __('Close') }}</button>
                                                <form id="delete-form-{{$item->servicewithprice_uuid}}"
                                                      action="{{route('serviceswithprices.destroy',$item->servicewithprice_uuid)}}"
                                                      method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
