                                                        ...
                                                        <div class="grid grid-cols-3 gap-4 px-8">
                                                            ...
                                                            <div class="col-span-1">
                                                                ...
                                                                <div class="text-center"
                                                                     id="quantity-bill-200-{{$item->sale_uuid}}"></div>
                                                                <div class="text-center"
                                                                     id="quantity-bill-100-{{$item->sale_uuid}}"></div>
                                                                <div class="text-center"
                                                                     id="quantity-bill-50-{{$item->sale_uuid}}"></div>
                                                                <div class="text-center"
                                                                     id="quantity-bill-20-{{$item->sale_uuid}}"></div>
                                                                <div class="text-center"
                                                                     id="quantity-bill-10-{{$item->sale_uuid}}"></div>
                                                                <div class="text-center"
                                                                     id="quantity-coin-5-{{$item->sale_uuid}}"></div>
                                                                <div class="text-center"
                                                                     id="quantity-coin-2-{{$item->sale_uuid}}"></div>
                                                                <div class="text-center"
                                                                     id="quantity-coin-1-{{$item->sale_uuid}}"></div>
                                                                <div class="text-center"
                                                                     id="quantity-coin-0-5-{{$item->sale_uuid}}"></div>
                                                                <div class="text-center"
                                                                     id="quantity-coin-0-2-{{$item->sale_uuid}}"></div>
                                                                <div class="text-center"
                                                                     id="quantity-coin-0-1-{{$item->sale_uuid}}"></div>
                                                            </div>
                                                            <div class="col-span-1">
                                                                <div
                                                                    class="text-end text-gray-700 font-extrabold text-sm py-2">{{__('word.general.three_column')}}</div>
                                                                <div class="text-end"
                                                                     id="operation-bill-200-{{$item->sale_uuid}}"></div>
                                                                <div class="text-end"
                                                                     id="operation-bill-100-{{$item->sale_uuid}}"></div>
                                                                <div class="text-end"
                                                                     id="operation-bill-50-{{$item->sale_uuid}}"></div>
                                                                <div class="text-end"
                                                                     id="operation-bill-20-{{$item->sale_uuid}}"></div>
                                                                <div class="text-end"
                                                                     id="operation-bill-10-{{$item->sale_uuid}}"></div>
                                                                <div class="text-end"
                                                                     id="operation-coin-5-{{$item->sale_uuid}}"></div>
                                                                <div class="text-end"
                                                                     id="operation-coin-2-{{$item->sale_uuid}}"></div>
                                                                <div class="text-end"
                                                                     id="operation-coin-1-{{$item->sale_uuid}}"></div>
                                                                <div class="text-end"
                                                                     id="operation-coin-0-5-{{$item->sale_uuid}}"></div>
                                                                <div class="text-end"
                                                                     id="operation-coin-0-2-{{$item->sale_uuid}}"></div>
                                                                <div class="text-end"
                                                                     id="operation-coin-0-1-{{$item->sale_uuid}}"></div>
                                                                <div class="text-end"
                                                                     id="total-{{$item->sale_uuid}}"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="text-center py-6 md:pb-0 hidden"
                                                        ...
                                                        <div class="grid grid-cols-2 gap-4 px-8">
                                                            <div class="col-span-1">
                                                                ...
                                                                <div
                                                                    id="method-cashregister-{{$item->sale_uuid}}"></div>
                                                            </div>
                                                            <div class="col-span-1">
                                                                <div
                                                        ...
                                                        <div class="grid grid-cols-2 gap-4 px-8">
                                                            <div class="col-span-1">
                                                                <div
                                                                    class="text-center text-gray-700 font-extrabold text-sm py-2">{{__('word.general.four_column')}}</div>
                                                                <div
                                                                    id="method-bankregister-{{$item->sale_uuid}}"></div>
                                                            </div>
                                                            <div class="col-span-1">
                                                                <div
                                                                    class="text-center text-gray-700 font-extrabold text-sm py-2">{{__('word.general.three_column')}}</div>
