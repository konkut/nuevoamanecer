...
<head>
    ...
    <!--Meta -->
    <title>{{ $title ?? __('word.general.app') }} - {{__('word.error.408.title')}}</title>
...
<div class="text-center">
    <h1 class="text-2xl font-bold mb-2">{{__('word.error.408.title')}}</h1>
    <p class="text-gray-300 text-md mb-4">{{__('word.error.408.subtitle')}}</p>
...
<div class="mt-8">
    <img class="max-w-full h-auto object-contain" src="{{ asset('images/error/408.jpg') }}" alt="Error 408">
</div>
</body>
</html>
