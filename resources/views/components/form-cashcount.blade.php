<div class="mt-4">
  <x-label for="physical_balance" value="{{ __('word.cashcount.attribute.physical_balance') }} *" />
  <div class="relative">
    ...
    <x-input id="physical_balance"
             ...
             value="{{ old('physical_balance', $cashcount->physical_balance?? '') }}" />
  </div>
</div>
<div class="mt-4">
    <x-label for="observation" value="{{ __('word.cashcount.attribute.observation') }}" />
    <div class="relative">
        ...
        <x-input id="observation"
                 ...
                 value="{{ old('observation', $cashcount->observation?? '') }}" />
    </div>
</div>
