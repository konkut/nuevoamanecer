...
<div class="mt-4">
  ...
  <div class="relative">
    ...
    <x-input required id="price" class="focus-and-blur pl-9 block mt-1 w-full" type="text"
...
<div class="mt-4">
    ...
    <div class="relative">
        <i class="bi bi-cash absolute top-1.5 left-2 text-[1.3em] text-[#d1d5db]"></i>
        <x-input required id="stock" class="focus-and-blur pl-9 block mt-1 w-full" type="text"
