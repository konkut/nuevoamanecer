<div>
  ...
  <div class="relative">
    ...
    <x-input id="name" class="pl-9 block mt-1 w-full" type="text" name="name" value="{{ old('name', $service->name?? '') }}" />
  </div>
  @error('name')
...
<div class="mt-4">
  ...
  <div class="relative">
    ...
    <x-input id="description" class="pl-9 block mt-1 w-full" type="text" name="description" value="{{ old('description', $service->description?? '') }}" />
  </div>
  @error('description')
  <small class="font-bold text-red-500/80">{{ $message }}</small>
  @enderror
...
<div class="relative">
  ...
  <x-input id="amount" class="pl-9 block mt-1 w-full" type="text" name="amount" value="{{ old('amount', $service->amount?? '') }}" />
</div>
@error('amount')
<small class="font-bold text-red-500/80">{{ $message }}</small>
@enderror
...
<div class="mt-4">
  ...
  <div class="relative">
    ...
    <x-input id="commission" class="pl-9 block mt-1 w-full" type="text" name="commission" value="{{ old('commission', $service->commission?? '') }}" />
  </div>
  @error('commission')
  <small class="font-bold text-red-500/80">{{ $message }}</small>
  @enderror
