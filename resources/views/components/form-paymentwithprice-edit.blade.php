    ...
    @foreach ($services as $index => $serviceUuid)
        ...
        <div class="mt-4 w-full md:w-1/2">
            ...
            <div class="relative">
                ...
                <x-input id="name" class="pl-9 pr-3 py-2 block mt-1 w-full" type="text" name="names[]" value="{{ $names[$index] ?? '' }}"/>
            </div>
        </div>
        <div class="mt-4 w-full md:w-1/2">
            ...
            <div class="relative">
                ...
                <x-input id="amount" onkeyup="updateCharge_paymentwithprice()" class="amount-input pl-9 pr-3 py-2 block mt-1 w-full" type="text" name="amounts[]" value="{{ $amounts[$index]?? '' }}" />
            </div>
        </div>
        <div class="mt-4 w-full md:w-1/2">
            ...
            <div class="relative">
                ...
                <x-input id="commission" onkeyup="updateCharge_paymentwithprice()" class="amount-input pl-9 pr-3 py-2 block mt-1 w-full" type="text" name="commissions[]" value="{{ $commissions[$index]?? '' }}" />
            </div>
        </div>
        <div class="mt-4 w-full md:w-1/2">
