                        ...
                        <div
                            ...
                            <div class="py-12 px-4 rounded-b-2xl shadow-inner md:max-w-2xl">
                                <form method="POST"
                                    ...
                                    @endphp
                                    <x-form-analyticalaccount :analyticalaccount="$analyticalaccount"
                                                              :allmainaccounts="$all_mainaccounts" page="edit"/>
                        ...
                        <div
                            ...
                            <div class="modal-body p-6">
                                <p class="text-gray-600">{{__('word.analyticalaccount.delete_confirmation')}}
                                    <strong
                                        id="name-{{$item->analyticalaccount_uuid}}"></strong>{{__('word.general.delete_warning')}}
                                </p>
                            </div>
                            <div class="modal-footer p-4 border-t flex justify-end space-x-2">
                                <button type="button"
            ...
            <div
                ...
                <div class="py-12 px-4 rounded-b-2xl shadow-inner md:max-w-2xl">
                    <form method="POST" action="{{ route('analyticalaccounts.store') }}">
                        @csrf
                        <x-form-analyticalaccount :analyticalaccount="$analyticalaccount"
                                                  :allmainaccounts="$all_mainaccounts" page="create"/>
                        <div class="mt-4 flex justify-end">
                            <x-button>
                                {{ __('Save') }}
                            </x-button>
