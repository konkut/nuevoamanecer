                        ...
                        <div
                            ...
                            <div class="py-12 px-4 rounded-b-2xl shadow-inner md:max-w-2xl">
                                <form method="POST"
                                    ...
                                    @endphp
                                    <x-form-accountsubgroup :accountsubgroup="$accountsubgroup"
                                                            :allaccountgroups="$all_accountgroups" page="edit"/>
            ...
            <div
                ...
                <div class="py-12 px-4 rounded-b-2xl shadow-inner md:max-w-2xl">
                    <form method="POST" action="{{ route('accountsubgroups.store') }}">
                        @csrf
                        <x-form-accountsubgroup :accountsubgroup="$accountsubgroup"
                                                :allaccountgroups="$all_accountgroups" page="create"/>
                        <div class="mt-4 flex justify-end">
                            <x-button>
                                {{ __('Save') }}
                            </x-button>
