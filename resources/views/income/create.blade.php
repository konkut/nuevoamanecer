<x-app-layout>
    <x-slot name="title">
        {{ __('word.income.meta.create.title') }}
    </x-slot>
    <x-slot name="metaDescription">
        {{ __('word.income.meta.create.description')}}
    </x-slot>
    <x-slot name="metaKeywords">
        {{ __('word.income.meta.create.keywords')}}
    </x-slot>
    ...
    <x-slot name="js_files">
        ...
        <script type="text/javascript" src="{{ asset('/js/income/ticketing_service.js?v='.time()) }}"></script>
        <script type="text/javascript" src="{{ asset('/js/income/ticketing_amount.js?v='.time()) }}"></script>
        <script type="text/javascript" src="{{ asset('/js/income/ticketing_method.js?v='.time()) }}"></script>
        <script type="text/javascript" src="{{ asset('/js/income/fetch_total.js?v='.time()) }}"></script>
