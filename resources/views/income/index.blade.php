                                        ...
                                        <td class="border-t border-b border-[#d1d5db] px-2 py-1">
                                            <div class="flex justify-center space-x-1">
                                                ...
                                                <form id="details-form-{{$item->income_uuid}}"
                                                    ...
                                                    @csrf
                                                    <button type="button"
                                                            onclick="fetch_detail_income('{{$item->income_uuid}}')"
                                            ...
                                            <div
                                                ...
                                                <div class="modal-header p-4 border-b flex justify-between items-center">
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            onclick="close_receipt_modal('{{$item->income_uuid}}')">&times;
                                                    </button>
                                                </div>
                                                ...
                                                <div class="modal-footer p-4 border-t flex justify-end space-x-2">
                                                    ...
                                                    <form action="{{route('receipts.store',$item->income_uuid)}}"
                                                          method="POST">
                                                        @csrf
                                                        <button type="submit"
                                                ...
                                                <div class="modal-body py-6 text-gray-700 overflow-hidden text-center">
                                                    ...
                                                    <div class="text-center py-6 md:pb-0 hidden"
                                                        ...
                                                        <div class="grid grid-cols-3 gap-4 px-8">
                                                            ...
                                                            <div class="col-span-1">
                                                                ...
                                                                <div class="text-center" id="quantity-bill-200-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="quantity-bill-100-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="quantity-bill-50-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="quantity-bill-20-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="quantity-bill-10-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="quantity-coin-5-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="quantity-coin-2-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="quantity-coin-1-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="quantity-coin-0-5-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="quantity-coin-0-2-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="quantity-coin-0-1-{{$item->income_uuid}}"></div>
                                                            </div>
                                                            <div class="col-span-1">
                                                                <div class="text-end text-gray-700 font-extrabold text-sm py-2">{{__('word.general.three_column')}}</div>
                                                                <div class="text-end" id="operation-bill-200-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="operation-bill-100-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="operation-bill-50-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="operation-bill-20-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="operation-bill-10-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="operation-coin-5-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="operation-coin-2-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="operation-coin-1-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="operation-coin-0-5-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="operation-coin-0-2-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="operation-coin-0-1-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="total-{{$item->income_uuid}}"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="text-center py-6 md:pb-0 hidden"
                                                        ...
                                                        <div class="grid grid-cols-3 gap-4 px-8">
                                                            ...
                                                            <div class="col-span-1">
                                                                <div class="text-center text-gray-700 font-extrabold text-sm py-2">{{__('word.general.two_column')}}</div>
                                                                <div class="text-center" id="value-bill-200-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="value-bill-100-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="value-bill-50-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="value-bill-20-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="value-bill-10-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="value-coin-5-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="value-coin-2-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="value-coin-1-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="value-coin-0-5-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="value-coin-0-2-{{$item->income_uuid}}"></div>
                                                                <div class="text-center" id="value-coin-0-1-{{$item->income_uuid}}"></div>
                                                            </div>
                                                            <div class="col-span-1">
                                                                <div class="text-end text-gray-700 font-extrabold text-sm py-2">{{__('word.general.three_column')}}</div>
                                                                <div class="text-end" id="amount-bill-200-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="amount-bill-100-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="amount-bill-50-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="amount-bill-20-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="amount-bill-10-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="amount-coin-5-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="amount-coin-2-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="amount-coin-1-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="amount-coin-0-5-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="amount-coin-0-2-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="amount-coin-0-1-{{$item->income_uuid}}"></div>
                                                                <div class="text-end" id="total-payment-{{$item->income_uuid}}"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="text-center py-6 md:pb-0 hidden"
                                                    ...
                                                    <div class="text-center py-6 md:pb-0 hidden"
                                                        ...
                                                        <div class="grid grid-cols-2 gap-4 px-8">
                                                            <div class="col-span-1">
                                                                <div class="text-center text-gray-700 font-extrabold text-sm py-2">{{__('word.general.four_column')}}</div>
                                                                <div id="method-bankregister-{{$item->income_uuid}}"></div>
                                                            </div>
                                                            <div class="col-span-1">
                                                                <div class="text-center text-gray-700 font-extrabold text-sm py-2">{{__('word.general.three_column')}}</div>
                                                                <div id="total-bankregister-{{$item->income_uuid}}"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="text-center py-6 md:pb-0 hidden"
