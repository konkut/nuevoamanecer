                        ...
                        <table class="min-w-full border-collapse border-[#2563eb] text-center text-sm">
                            ...
                            <tr class="bg-[#d1d5db]" title="Buscar">
                                ...
                                <th class="border-t border-b border-[#d1d5db] px-2 py-1 cursor-pointer"
                                    onclick="enableSearch(this, 'servicio')">{{ __('word.income.attribute.service_uuid') }}</th>
                                <th class="border-t border-b border-[#d1d5db] px-2 py-1 cursor-pointer"
                                    onclick="enableSearch(this, 'medio de cobro')">{{ __('word.income.attribute.input_name') }}</th>
                                <th class="border-t border-b border-[#d1d5db] px-2 py-1 cursor-pointer"
                                    onclick="enableSearch(this, 'total de cobro')">{{ __('word.income.attribute.input_amount') }}</th>
                                <th class="border-t border-b border-[#d1d5db] px-2 py-1 cursor-pointer"
                                    onclick="enableSearch(this, 'plataforma de pago')">{{ __('word.income.attribute.output_name') }}</th>
                                <th class="border-t border-b border-[#d1d5db] px-2 py-1 cursor-pointer"
                                    onclick="enableSearch(this, 'total de pago')">{{ __('word.income.attribute.output_amount') }}</th>
                                <th class="border-t border-b border-[#d1d5db] px-2 py-1 cursor-pointer"
                                    onclick="enableSearch(this, 'fecha de registro')">{{ __('word.income.attribute.created_at') }}</th>
                                <th class="border-t border-b border-[#d1d5db] px-2 py-1 cursor-pointer"
                                    onclick="enableSearch(this, 'registrado por')">{{ __('word.income.attribute.user_id') }}</th>
                            ...
                            @foreach($incomes as $item)
                                ...
                                @if(auth()->user()->hasRole('Administrador') || $item->user_id == Auth::id())
                                    <tr class="hover:bg-[#d1d5db44] transition duration-200">
                                        ...
                                        <td class="border-t border-b border-[#d1d5db] px-2 py-1">{{ implode(', ', $item->services) }}</td>
                                        <td class="border-t border-b border-[#d1d5db] px-2 py-1">{{ implode(', ', $item->input_name) }}</td>
                                        <td class="border-t border-b border-[#d1d5db] px-2 py-1">{{ number_format($item->input_total,1) }}</td>
                                        <td class="border-t border-b border-[#d1d5db] px-2 py-1">
                                            @if(!empty(implode(', ', $item->output_name)))
                                                {{implode(', ', $item->output_name)}}
                                            @else
                                                {{ "No aplica" }}
                                            @endif
                                        </td>
                                        <td class="border-t border-b border-[#d1d5db] px-2 py-1">{{ number_format($item->output_total,1) }}</td>
                                        ...
                                        <td class="border-t border-b border-[#d1d5db] px-2 py-1">
                                            <div class="flex justify-center space-x-1">
                                                <a href="{{ route('incomes.tax', $item->income_uuid) }}"
                                                   target="_blank"
                                                ...
                                                <form id="details-form-{{$item->income_uuid}}"
                                                    ...
                                                    @csrf
                                                    <button type="button"
                                                            onclick="fetchDetails('{{$item->income_uuid}}')"
                                                ...
                                                @if($validation)
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            onclick="openModal('{{ $item->income_uuid }}', '{{ implode(', ', $item->services) }}')"
                                                            title="Eliminar">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    ...
                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                        ...
                                                        <div class="text-center pb-8 md:pb-0"
                                                            ...
                                                            <div class="bg-[#f3f4f6] p-2">
                                                                <div class="font-bold py-1 text-sm text-center">INGRESO
                                                                    FÍSICO
                                                                </div>
                                                            </div>
                                                            <div class="divide-y divide-[#f3f4f6]">
                                                                <div
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-bill-200-{{$item->income_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-bill-100-{{$item->income_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-bill-50-{{$item->income_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-bill-20-{{$item->income_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-bill-10-{{$item->income_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-coin-5-{{$item->income_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-coin-2-{{$item->income_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-coin-1-{{$item->income_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-coin-0-5-{{$item->income_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-coin-0-2-{{$item->income_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-coin-0-1-{{$item->income_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-physical-{{$item->income_uuid}}"></div>
                                                                </div>
                                                            </div>
                                                            <div class="bg-[#f3f4f6] p-2">
                                                                <div class="font-bold py-1 text-sm text-center">INGRESO
                                                            ...
                                                            <div class="divide-y divide-[#f3f4f6]">
                                                                <div
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-digital-{{$item->income_uuid}}"></div>
                                                                </div>
                                                            </div>
                                                            <div class="bg-[#f3f4f6] p-2">
                                                            ...
                                                            <div
                                                                class="divide-y divide-[#f3f4f6] font-extrabold text-red-500">
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    <div class="w-1/3 text-start">Total</div>
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-total-{{$item->income_uuid}}"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
