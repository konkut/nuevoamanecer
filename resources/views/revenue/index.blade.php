                                                ...
                                                <div class="modal-body py-6 text-gray-700 overflow-hidden text-center">
                                                    ...
                                                    <div class="text-center py-6 md:pb-0 hidden"
                                                        ...
                                                        <div class="grid grid-cols-3 gap-4 px-8">
                                                            ...
                                                            <div class="col-span-1">
                                                                ...
                                                                <div class="text-center" id="quantity-bill-200-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-center" id="quantity-bill-100-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-center" id="quantity-bill-50-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-center" id="quantity-bill-20-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-center" id="quantity-bill-10-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-center" id="quantity-coin-5-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-center" id="quantity-coin-2-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-center" id="quantity-coin-1-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-center" id="quantity-coin-0-5-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-center" id="quantity-coin-0-2-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-center" id="quantity-coin-0-1-{{$item->revenue_uuid}}"></div>
                                                            </div>
                                                            <div class="col-span-1">
                                                                <div class="text-end text-gray-700 font-extrabold text-sm py-2">{{__('word.general.three_column')}}</div>
                                                                <div class="text-end" id="operation-bill-200-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-end" id="operation-bill-100-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-end" id="operation-bill-50-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-end" id="operation-bill-20-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-end" id="operation-bill-10-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-end" id="operation-coin-5-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-end" id="operation-coin-2-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-end" id="operation-coin-1-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-end" id="operation-coin-0-5-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-end" id="operation-coin-0-2-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-end" id="operation-coin-0-1-{{$item->revenue_uuid}}"></div>
                                                                <div class="text-end" id="total-{{$item->revenue_uuid}}"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="text-center py-6 md:pb-0 hidden"
                                                    ...
                                                    <div class="text-center py-6 md:pb-0 hidden"
                                                        ...
                                                        <div class="grid grid-cols-2 gap-4 px-8">
                                                            <div class="col-span-1">
                                                                <div class="text-center text-gray-700 font-extrabold text-sm py-2">{{__('word.general.four_column')}}</div>
                                                                <div id="method-bankregister-{{$item->revenue_uuid}}"></div>
                                                            </div>
                                                            <div class="col-span-1">
                                                                <div class="text-center text-gray-700 font-extrabold text-sm py-2">{{__('word.general.three_column')}}</div>
                                                                <div id="total-bankregister-{{$item->revenue_uuid}}"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="text-center py-6 md:pb-0 hidden"
                                            ...
                                            <div class="bg-white rounded-lg shadow-lg w-5/6 sm:w-3/6 lg:w-2/6 transform transition-all scale-100 opacity-100 duration-300">
                                                ...
                                                <div class="modal-body p-6">
                                                    <p class="text-gray-600">{{__('word.revenue.delete_confirmation')}}
                                                        <strong id="name-{{$item->revenue_uuid}}"></strong>{{__('word.general.delete_warning')}}
                                                    </p>
                                                </div>
                                                <div class="modal-footer p-4 border-t flex justify-end space-x-2">
                                                    <button type="button"
