<x-app-layout>
    <x-slot name="title">
        {{ __('word.cashcount.meta.create.title') }}
    </x-slot>
    <x-slot name="metaDescription">
        {{ __('word.cashcount.meta.create.description')}}
    </x-slot>
    <x-slot name="metaKeywords">
        {{ __('word.cashcount.meta.create.keywords')}}
    </x-slot>
    ...
    <x-slot name="js_files">
        ...
        <script type="text/javascript" src="{{ asset('/js/cashcount/ticketing.js?v='.time()) }}"></script>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('word.cashcount.resource.create') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 px-4">
            <div class="bg-white overflow-hidden shadow-xl rounded-lg w-full mx-auto p-8">
                <form method="POST" action="{{ route('cashcounts.store') }}">
                    @csrf
