    ...
    <div class="mx-auto flex bg-gray-800 text-gray-200 rounded-2xl shadow-2xl overflow-hidden max-w-4xl p-8 transition-transform transform hover:scale-105 hover:shadow-lg">
      <div class="p-6 text-center">
        ...
        <div class="mt-6">
          ...
          <p class="text-md text-gray-200">{{ $incomefromtransfer->amount }}</p>
        </div>

        <div class="mt-4">
          <p class="text-sm font-semibold text-gray-400">{{ __('word.incomefromtransfer.attribute.service_uuid') }}</p>
          <p class="text-md text-gray-200">{{ $incomefromtransfer->service->name }}</p>
        </div>

        @if($incomefromtransfer->commission)
        <div class="mt-6">
          <p class="text-sm font-semibold text-gray-400">{{ __('word.incomefromtransfer.attribute.commission') }}</p>
          <p class="text-md text-gray-200">{{ $incomefromtransfer->commission }}</p>
        </div>
        @endif
