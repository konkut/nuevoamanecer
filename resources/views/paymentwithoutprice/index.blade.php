            ...
            <div class="overflow-hidden shadow-xl sm:rounded-lg">
                <div class="container mx-auto p-4">
                    <div class="flex justify-end space-x-2 items-center mb-4">
                        <a href="{{ route('paymentwithoutprices.export') }}"
                                    ...
                                    <tr class="hover:bg-[#d1d5db44] transition duration-200">
                                        ...
                                        <td class="border-t border-b border-[#d1d5db] px-2 py-1">
                                            <div class="flex justify-center space-x-1">
                                                <a href="{{ route('paymentwithoutprices.tax', $item->paymentwithoutprice_uuid) }}"
                                                   target="_blank"
                                                ...
                                                <form id="details-form-{{$item->paymentwithoutprice_uuid}}"
                                                      title="Visualizar"
                                                      action="{{ route('paymentwithoutprices.detail', $item->paymentwithoutprice_uuid) }}"
                                                ...
                                                <div class="modal-body py-6 px-4 sm:px-6 text-gray-700 overflow-hidden">
                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                        <div class="text-center">
                                                            <div class="mt-4">
                                                                <p class="text-sm font-semibold">{{ __('word.payment.attribute.servicewithprice_uuid') }}</p>
                                                        ...
                                                        <div class="text-center pb-8 md:pb-0"
                                                             id="modal-show-{{$item->paymentwithoutprice_uuid}}">
                                                            ...
                                                            <div class="divide-y divide-[#f3f4f6]">
                                                                <div
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-bill-200-{{$item->paymentwithoutprice_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-bill-100-{{$item->paymentwithoutprice_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-bill-50-{{$item->paymentwithoutprice_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-bill-20-{{$item->paymentwithoutprice_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-bill-10-{{$item->paymentwithoutprice_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-coin-5-{{$item->paymentwithoutprice_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-coin-2-{{$item->paymentwithoutprice_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-coin-1-{{$item->paymentwithoutprice_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-coin-0-5-{{$item->paymentwithoutprice_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-coin-0-2-{{$item->paymentwithoutprice_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-coin-0-1-{{$item->paymentwithoutprice_uuid}}"></div>
                                                                </div>
                                                                <div
                                                                    class="flex hover:bg-[#d1d5db44] transition duration-200 py-1">
                                                                    <div class="w-1/3 text-end">Bs&nbsp;&nbsp;</div>
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-physical-{{$item->paymentwithoutprice_uuid}}"></div>
                                                                </div>
                                                            </div>
                                                            <div class="bg-[#f3f4f6] p-2">
                                                            ...
                                                            <div class="divide-y divide-[#f3f4f6]">
                                                                <div
                                                                    ...
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-digital-{{$item->paymentwithoutprice_uuid}}"></div>
                                                                </div>
                                                            </div>
                                                            <div class="bg-[#f3f4f6] p-2">
                                                            ...
                                                            <div class="divide-y divide-[#f3f4f6] font-extrabold text-red-500">
                                                                <div
                                                                    ...
                                                                    <div class="w-1/3 text-start">Total</div>
                                                                    <div class="w-1/2 text-start"
                                                                         id="initial-balance-total-{{$item->paymentwithoutprice_uuid}}"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
