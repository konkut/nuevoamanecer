...
Route::middleware([
    ...
    Route::put("/categories/disable/{category_id}", [CategoryController::class, "disable"])->name("categories.disable");
    Route::put("/categories/enable/{category_id}", [CategoryController::class, "enable"])->name("categories.enable");
    ...
    Route::put("/services/disable/{service_uuid}", [ServiceController::class, "disable"])->name("services.disable");
    Route::put("/services/enable/{service_uuid}", [ServiceController::class, "enable"])->name("services.enable");
    ...
    Route::put("/methods/disable/{method_uuid}", [MethodController::class, "disable"])->name("methods.disable");
    Route::put("/methods/enable/{method_uuid}", [MethodController::class, "enable"])->name("methods.enable");
    ...
    Route::put("/cashregisters/disable/{cashregister_uuid}", [CashregisterController::class, "disable"])->name("cashregisters.disable");
    Route::put("/cashregisters/enable/{cashregister_uuid}", [CashregisterController::class, "enable"])->name("cashregisters.enable");
    ...
    Route::get('/cashshifts/price/{cashshift_uuid}', [CashshiftController::class, 'price'])->name('cashshifts.price');
    Route::get('/cashshifts/amount/{cashshift_uuid}', [CashshiftController::class, 'amount'])->name('cashshifts.amount');
    ...
    Route::put('/cashshifts/enable/{cashshift_uuid}', [CashshiftController::class, 'enable'])->name('cashshifts.enable');
    Route::put('/cashshifts/disable/{cashshift_uuid}', [CashshiftController::class, 'disable'])->name('cashshifts.disable');
    ...
    /*CASHCOUNT*/
    Route::get("/cashshifts/{cashshift_uuid}/", [CashcountController::class, "create"])->name("cashcounts.create");
    Route::post("/cashshifts/{cashshift_uuid}", [CashcountController::class, "store"])->name("cashcounts.store");
    Route::get('/cashshifts/{cashshift_uuid}/edit', [CashcountController::class, 'edit'])->name('cashcounts.edit');
    Route::put('/cashshifts/{cashshift_uuid}', [CashcountController::class, 'update'])->name('cashcounts.update');
    ...
    Route::put("/products/disable/{product_uuid}", [ProductController::class, "disable"])->name("products.disable");
    Route::put("/products/enable/{product_uuid}", [ProductController::class, "enable"])->name("products.enable");
    ...
    Route::put("/bankregisters/disable/{bankregister_uuid}", [BankregisterController::class, "disable"])->name("bankregisters.disable");
    Route::put("/bankregisters/enable/{bankregister_uuid}", [BankregisterController::class, "enable"])->name("bankregisters.enable");
